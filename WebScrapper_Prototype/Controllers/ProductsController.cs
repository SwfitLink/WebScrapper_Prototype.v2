...
namespace WebScrapper_Prototype.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(WebScrapper_PrototypeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,ProductName,ProductDescription,ProductStatus,ProductCategory,ActualPrice,ScrappedPrice,ImageURL")] Product product)
        {
